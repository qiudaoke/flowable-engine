 ...
 * @author shareniu
 */
public class A1CategoryTest extends ResourceFlowableTestCase {

    public A1CategoryTest() {
        super("org/flowable/a1bpm/simple/flowable.cfg.xml");
    }
    //A1CategoryTest.testSimple.bpmn20.xml
    @Test
 @Deployment
    public void testSimple() {
                ProcessInstance pi = runtimeService.startProcessInstanceByKey("f");
